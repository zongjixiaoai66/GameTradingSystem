    ...
    */
    ...
    public R save(@RequestBody ShangpinEntity shangpin, HttpServletRequest request){
        ...
        Wrapper<ShangpinEntity> queryWrapper = new EntityWrapper<ShangpinEntity>()
            ...
            .eq("youxiwanfa_types", shangpin.getYouxiwanfaTypes())
            .eq("jiaoyileixing_types", shangpin.getJiaoyileixingTypes())
            .eq("caozuofangshi_types", shangpin.getCaozuofangshiTypes())
            .eq("remen_types", shangpin.getRemenTypes())
...
//                            shangpinEntity.setShangpinTypes(Integer.valueOf(data.get(0)));   //游戏类型 要改的
//                            shangpinEntity.setYouxiwanfaTypes(Integer.valueOf(data.get(0)));   //游戏玩法 要改的
//                            shangpinEntity.setJiaoyileixingTypes(Integer.valueOf(data.get(0)));   //交易类型 要改的
//                            shangpinEntity.setCaozuofangshiTypes(Integer.valueOf(data.get(0)));   //操作方式 要改的
//                            shangpinEntity.setRemenTypes(Integer.valueOf(data.get(0)));   //是否热门 要改的
