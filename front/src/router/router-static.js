...
import center from '@/views/center'
    ...
    import dictionaryCaozuofangshi from '@/views/modules/dictionaryCaozuofangshi/list'
    ...
    import dictionaryJiaoyileixing from '@/views/modules/dictionaryJiaoyileixing/list'
    import dictionaryRemen from '@/views/modules/dictionaryRemen/list'
    ...
    import dictionaryYouxiwanfa from '@/views/modules/dictionaryYouxiwanfa/list'
...
const routes = [{
    ...
    ,{
        path: '/dictionaryCaozuofangshi',
        name: '操作方式',
        component: dictionaryCaozuofangshi
    }
    ,{
    ...
    ,{
        path: '/dictionaryJiaoyileixing',
        name: '交易类型',
        component: dictionaryJiaoyileixing
    }
    ,{
        path: '/dictionaryRemen',
        name: '是否热门',
        component: dictionaryRemen
    }
    ,{
        path: '/dictionarySex',
        name: '性别类型',
    ...
    ,{
        path: '/dictionaryYouxiwanfa',
        name: '游戏玩法',
        component: dictionaryYouxiwanfa
    }
    ,{
        path: '/config',
        name: '轮播图',
