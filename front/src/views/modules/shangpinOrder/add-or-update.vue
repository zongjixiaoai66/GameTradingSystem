               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="兑换网址" prop="shangpinOrderCourierName">
                       <el-input v-model="ruleForm.shangpinOrderCourierName"
                                 placeholder="兑换网址" clearable  :readonly="ro.shangpinOrderCourierName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="兑换码" prop="shangpinOrderCourierNumber">
                       <el-input v-model="ruleForm.shangpinOrderCourierNumber"
                                 placeholder="兑换码" clearable  :readonly="ro.shangpinOrderCourierNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   shangpinOrderCourierName: [
                              { required: true, message: '兑换网址不能为空', trigger: 'blur' },
                          ],
                   shangpinOrderCourierNumber: [
