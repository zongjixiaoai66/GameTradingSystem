                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/youxijiaoyixitong/upload/shangpinOrderMuBan.xls"
                        >批量导入商品订单数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('shangpinOrder','导入导出')"
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                ...
                //本表字段
                     ...
                     '兑换网址': "shangpinOrderCourierName",
                     '兑换码': "shangpinOrderCourierNumber",
        ...
        methods: {
            ...
            if(this.shangpinOrderCourierNumber == ""
				|| this.shangpinOrderCourierNumber == null
				|| this.shangpinOrderCourierNumber == "null"){
				return this.$message.error("兑换码不能为空");
			}
 			if(this.shangpinOrderCourierName == ""
				|| this.shangpinOrderCourierName == null
				|| this.shangpinOrderCourierName == "null"){
				return this.$message.error("兑换网址不能为空");
			}
