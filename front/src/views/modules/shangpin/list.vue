        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '游戏类型' : ''">
                        <el-select v-model="searchForm.shangpinTypes" placeholder="请选择游戏类型">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '游戏玩法' : ''">
                        <el-select v-model="searchForm.youxiwanfaTypes" placeholder="请选择游戏玩法">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                               v-for="(item,index) in youxiwanfaTypesSelectSearch"
                               v-bind:key="index"
                               :label="item.indexName"
                               :value="item.codeIndex">
                            <!--lable是要展示的名称-->
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '交易类型' : ''">
                        <el-select v-model="searchForm.jiaoyileixingTypes" placeholder="请选择交易类型">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                               v-for="(item,index) in jiaoyileixingTypesSelectSearch"
                               v-bind:key="index"
                               :label="item.indexName"
                               :value="item.codeIndex">
                            <!--lable是要展示的名称-->
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '操作方式' : ''">
                        <el-select v-model="searchForm.caozuofangshiTypes" placeholder="请选择操作方式">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                               v-for="(item,index) in caozuofangshiTypesSelectSearch"
                               v-bind:key="index"
                               :label="item.indexName"
                               :value="item.codeIndex">
                            <!--lable是要展示的名称-->
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/youxijiaoyixitong/upload/shangpinMuBan.xls"
                        >批量导入商品数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('shangpin','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="youxiwanfaTypes"
                                      header-align="center"
                                      label="游戏玩法">
                        <template slot-scope="scope">
                            {{scope.row.youxiwanfaValue}}
                        </template>
                    </el-table-column>
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="jiaoyileixingTypes"
                                      header-align="center"
                                      label="交易类型">
                        <template slot-scope="scope">
                            {{scope.row.jiaoyileixingValue}}
                        </template>
                    </el-table-column>
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="caozuofangshiTypes"
                                      header-align="center"
                                      label="操作方式">
                        <template slot-scope="scope">
                            {{scope.row.caozuofangshiValue}}
                        </template>
                    </el-table-column>
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="remenTypes"
...
<script>
    ...
    //当前表下拉框搜索条件
              ...
              youxiwanfaTypesSelectSearch : [],
              jiaoyileixingTypesSelectSearch : [],
              caozuofangshiTypesSelectSearch : [],
            form:{
                id : null,
                shangpinName : null,
                ...
                shangpinPhoto : null,
                shangpinTypes : null,
                youxiwanfaTypes : null,
                jiaoyileixingTypes : null,
                caozuofangshiTypes : null,
                remenTypes : null,
            ...
            json_fields: {
                ...
                //本表字段
                     ...
                     '商品照片': "shangpinPhoto",
                     '游戏类型': "shangpinTypes",
                     '游戏玩法': "youxiwanfaTypes",
                     '交易类型': "jiaoyileixingTypes",
                     '操作方式': "caozuofangshiTypes",
                     '是否热门': "remenTypes",
        ...
        methods: {
            ...
            getDataList() {
                ...
                if (this.searchForm.youxiwanfaTypes!= '' && this.searchForm.youxiwanfaTypes!= undefined) {
                    params['youxiwanfaTypes'] = this.searchForm.youxiwanfaTypes
                }
         
                if (this.searchForm.jiaoyileixingTypes!= '' && this.searchForm.jiaoyileixingTypes!= undefined) {
                    params['jiaoyileixingTypes'] = this.searchForm.jiaoyileixingTypes
                }
         
                if (this.searchForm.caozuofangshiTypes!= '' && this.searchForm.caozuofangshiTypes!= undefined) {
                    params['caozuofangshiTypes'] = this.searchForm.caozuofangshiTypes
                }
                ...
                //填充下拉框选项
                this.$http({
                    url: "dictionary/page?dicCode=youxiwanfa_types&page=1&limit=100",
                    method: "get",
                }).then(({data}) => {
                    if(data && data.code === 0){
                        this.youxiwanfaTypesSelectSearch = data.data.list;
                    }
                });
                //填充下拉框选项
                this.$http({
                    url: "dictionary/page?dicCode=jiaoyileixing_types&page=1&limit=100",
                    method: "get",
                }).then(({data}) => {
                    if(data && data.code === 0){
                        this.jiaoyileixingTypesSelectSearch = data.data.list;
                    }
                });
                //填充下拉框选项
                this.$http({
                    url: "dictionary/page?dicCode=caozuofangshi_types&page=1&limit=100",
                    method: "get",
                }).then(({data}) => {
                    if(data && data.code === 0){
                        this.caozuofangshiTypesSelectSearch = data.data.list;
                    }
                });
            },
            //每页数
