    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='shangpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="游戏类型" prop="shangpinValue">
                        <el-input v-model="shangpinForm.shangpinValue"
                                  placeholder="游戏类型" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='shangpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="游戏玩法" prop="youxiwanfaValue">
                        <el-input v-model="shangpinForm.youxiwanfaValue"
                                  placeholder="游戏玩法" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='shangpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="交易类型" prop="jiaoyileixingValue">
                        <el-input v-model="shangpinForm.jiaoyileixingValue"
                                  placeholder="交易类型" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='shangpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="操作方式" prop="caozuofangshiValue">
                        <el-input v-model="shangpinForm.caozuofangshiValue"
                                  placeholder="操作方式" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='shangpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="是否热门" prop="remenValue">
                        <el-input v-model="shangpinForm.remenValue"
                                  placeholder="是否热门" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
